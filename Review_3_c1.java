...
public class Review_3_c1 {
    ...
    public static void main(String[] args) throws Exception {
        ...
        String strLine = "";
        String str_data = "";
        BufferedReader br = new BufferedReader(new FileReader("100_mb_file(cipher text1).txt"));
        while (strLine != null) {
            if (strLine == null) {
                break;
            }
        ...
        File my = new File("100_mb_file(cloud a).txt");
        my.createNewFile();
        System.out.println("Successfully created the file.");
        FileWriter myw = new FileWriter("100_mb_file(cloud a).txt");
        myw.write(e1);
        myw.close();
        ...
        File my1 = new File("100_mb_file(cloud b).txt");
        my.createNewFile();
        System.out.println("Successfully created the file.");
        FileWriter myw1 = new FileWriter("100_mb_file(cloud b).txt");
        myw1.write(e2);
        myw1.close();
        System.out.println("Successfully wrote to the file.");
        //Decryption
        ...
        String strLine1 = "";
        String str_data1 = "";
        BufferedReader br1 = new BufferedReader(new FileReader("100_mb_file(cloud a).txt"));
        while (strLine1 != null) {
            if (strLine1 == null) {
                break;
            }
        ...
        String strLine2 = "";
        String str_data2 = "";
        BufferedReader br2 = new BufferedReader(new FileReader("100_mb_file(cloud b).txt"));
        while (strLine2 != null) {
            if (strLine2 == null) {
                break;
            }
        ...
        if (D.equals(M)) {
            ...
            String m = M.toString();
            File my3 = new File("100_mb_file_ic(decipher text).txt");
            my.createNewFile();
            System.out.println("Successfully created the file.");
            FileWriter myw3 = new FileWriter("100_mb_file_ic(decipher text).txt");
            myw3.write(m);
            myw3.close();
            System.out.println("Successfully wrote to the file.");
        } else {
